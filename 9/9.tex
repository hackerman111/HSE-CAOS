...
\hypersetup{
  ...
  pdftitle={Оптимизации CPU, числа с плавающей запятой и многопоточность}
}
...
\newcommand{\LectureTitle}{Оптимизации CPU, числа с плавающей запятой и многопоточность}
...
\newacronym{oooe}{OoOE}{внеочередное исполнение инструкций (Out-of-Order Execution)}
