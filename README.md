...
---
На данный момент конспект актуален до лекций от 29.11.2025

---
Вот обновленное оглавление конспекта в формате Markdown, включающее новую **11-ю лекцию**, посвященную компьютерным сетям (на основе предоставленных вами страниц 115-127).
