...
\hypersetup{
  ...
  pdftitle={Управление процессами и представление данных}
}
...
\newcommand{\LectureNo}{5}
\newcommand{\LectureTitle}{Управление процессами и представление данных}
...
% "Methodichka"-style colored boxes
...
% Important: Russian comments in listings under pdfLaTeX may not display correctly — use ASCII if problems occur.
...
% Glossary and acronyms (requires makeglossaries/makeindex during build)
...
% Example of predefined terms (LLM can extend this block)
