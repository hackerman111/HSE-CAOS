...
\hypersetup{
  ...
  pdftitle={Deep Dive into Systems}
}
...
\fancyhf{}
% Макросы метаданных
\newcommand{\CourseName}{Deep Dive into Systems}
\newcommand{\LectureNo}{1}
\newcommand{\LectureTitle}{Signals \& Event Loops}
\newcommand{\LectureDate}{\today}
\newcommand{\Lecturer}{Expert System}
\fancyhead[L]{\small\sffamily \CourseName}
\fancyhead[C]{\small\sffamily \LectureTitle}
\fancyhead[R]{\small\sffamily Глава \LectureNo}
...
\usepackage{graphicx}
\usepackage{tikz}
\usetikzlibrary{arrows.meta,positioning,shapes.geometric,calc,fit,shapes.multipart,patterns}
\tikzset{
  ...
  process/.style={rectangle, draw=AccentDark, fill=white, text centered, minimum height=2em},
  kernel/.style={rectangle, draw=red!70!black, fill=red!10, text centered, minimum height=2em, rounded corners}
}
...
\newtcolorbox{warningbox}{
  ...
  colback=red!5, colframe=red!60!black, arc=2pt, left=8pt, right=8pt, top=6pt, bottom=6pt
}
...
\newacronym{pid}{PID}{идентификатор процесса}
\newacronym{fd}{FD}{файловый дескриптор}
\newacronym{tlb}{TLB}{буфер ассоциативной трансляции}
\newglossaryentry{signal}{name={сигнал}, description={механизм межпроцессного взаимодействия для уведомления процесса о событии}}
\newglossaryentry{syscall}{name={системный вызов}, description={интерфейс взаимодействия между процессом user-space и ядром ОС}}

% Титульные данные
\title{\sffamily Курс: \textit{\CourseName}\\\large Глава \LectureNo: \LectureTitle}
\author{\sffamily Автор курса: \Lecturer}
